 ...
 * @author yanming
 * @version 1.0.0
 * @description 提供redis增删等操作连接池
 * @date 2018/05/04 16:57
 **/
public class redisManager {
    ...
    static {
        try {
            ...
            sentinels.add("10.0.21.58:26379");
            sentinels.add("10.0.21.59:26379");
            sentinels.add("10.0.21.60:26379");
    ...
    public static void main(String[] args) {
        JedisSentinelPool pool = redisManager.getPool();
